...
void runSystematics( TString sys_name = "backgroundFunc", bool draw_ = true){

	TFile* file[3];

	TString default_name = "systematics-input/"+sys_name+"/output-Step_1-"+sys_name+"_20_default.root";
	TString sys_name_1   = "systematics-input/"+sys_name+"/output-Step_1-"+sys_name+"_20_simpleExp.root";
	TString sys_name_2   = "systematics-input/"+sys_name+"/output-Step_1-"+sys_name+"_20_simpleExp.root";

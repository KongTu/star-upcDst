...
void DSMAlgo_EM201_2015::operator()(DSM& dsm)
{
  ...
  unsigned int jpSum1; // Partial sum from EE101
  unsigned int jpSum2; // Partial sum from EE102
...
void getHybridJetPatchSums(const DSM& em201, unsigned int& jpSum1, unsigned int& jpSum2)
{
